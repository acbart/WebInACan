...
public class GetCurrentBusInfoWithXMLSchemaResponse  implements java.io.Serializable {
    private bustracker.GetCurrentBusInfoWithXMLSchemaResponseGetCurrentBusInfoWithXMLSchemaResult getCurrentBusInfoWithXMLSchemaResult;

    public GetCurrentBusInfoWithXMLSchemaResponse() {
    }

    public GetCurrentBusInfoWithXMLSchemaResponse(
           bustracker.GetCurrentBusInfoWithXMLSchemaResponseGetCurrentBusInfoWithXMLSchemaResult getCurrentBusInfoWithXMLSchemaResult) {
     ...
     */
    public bustracker.GetCurrentBusInfoWithXMLSchemaResponseGetCurrentBusInfoWithXMLSchemaResult getGetCurrentBusInfoWithXMLSchemaResult() {
        return getCurrentBusInfoWithXMLSchemaResult;
    }
     ...
     */
    public void setGetCurrentBusInfoWithXMLSchemaResult(bustracker.GetCurrentBusInfoWithXMLSchemaResponseGetCurrentBusInfoWithXMLSchemaResult getCurrentBusInfoWithXMLSchemaResult) {
        this.getCurrentBusInfoWithXMLSchemaResult = getCurrentBusInfoWithXMLSchemaResult;
    }

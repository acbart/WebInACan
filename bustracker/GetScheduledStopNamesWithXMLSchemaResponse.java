...
public class GetScheduledStopNamesWithXMLSchemaResponse  implements java.io.Serializable {
    private bustracker.GetScheduledStopNamesWithXMLSchemaResponseGetScheduledStopNamesWithXMLSchemaResult getScheduledStopNamesWithXMLSchemaResult;

    public GetScheduledStopNamesWithXMLSchemaResponse() {
    }

    public GetScheduledStopNamesWithXMLSchemaResponse(
           bustracker.GetScheduledStopNamesWithXMLSchemaResponseGetScheduledStopNamesWithXMLSchemaResult getScheduledStopNamesWithXMLSchemaResult) {
     ...
     */
    public bustracker.GetScheduledStopNamesWithXMLSchemaResponseGetScheduledStopNamesWithXMLSchemaResult getGetScheduledStopNamesWithXMLSchemaResult() {
        return getScheduledStopNamesWithXMLSchemaResult;
    }
     ...
     */
    public void setGetScheduledStopNamesWithXMLSchemaResult(bustracker.GetScheduledStopNamesWithXMLSchemaResponseGetScheduledStopNamesWithXMLSchemaResult getScheduledStopNamesWithXMLSchemaResult) {
        this.getScheduledStopNamesWithXMLSchemaResult = getScheduledStopNamesWithXMLSchemaResult;
    }

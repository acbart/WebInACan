...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements bin.test2.NdfdXML {
 ...
 */
    ...
    public bin.test2.NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public bin.test2.NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bin.test2.NdfdXMLBindingStub _stub = new bin.test2.NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (bin.test2.NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                bin.test2.NdfdXMLBindingStub _stub = new bin.test2.NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }

...
public class Business {
	...
	public Business(String id, boolean isClaimed, boolean isClosed,
			String name, String imageUrl, String url, String mobileUrl,
			String phone, String displayPhone, int review_count,
			List<BusinessCategory> categories, int distance,
			int ratingdistance, String ratingImageUrl,
			String ratingImageUrlSmall, String ratingImageUrlLarge,
			String snippetText, String snippetImageUrl,
			DetailedLocation location, List<Deal> deals,
			List<GiftCertificates> giftCertificates, List<Review> reviews) {
		this.id = id;

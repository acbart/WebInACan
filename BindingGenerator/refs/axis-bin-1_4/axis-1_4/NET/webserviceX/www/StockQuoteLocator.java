...
public class StockQuoteLocator extends org.apache.axis.client.Service implements NET.webserviceX.www.StockQuote {
    ...
    public NET.webserviceX.www.StockQuoteSoap getStockQuoteSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public NET.webserviceX.www.StockQuoteSoap getStockQuoteSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            NET.webserviceX.www.StockQuoteSoap12Stub _stub = new NET.webserviceX.www.StockQuoteSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            ...
            if (NET.webserviceX.www.StockQuoteSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                NET.webserviceX.www.StockQuoteSoap12Stub _stub = new NET.webserviceX.www.StockQuoteSoap12Stub(new java.net.URL(StockQuoteSoap12_address), this);
                _stub.setPortName(getStockQuoteSoap12WSDDServiceName());
                return _stub;
            }
        }

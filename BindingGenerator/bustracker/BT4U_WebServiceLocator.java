...
public class BT4U_WebServiceLocator extends org.apache.axis.client.Service implements bustracker.BT4U_WebService {
    ...
    public bustracker.BT4U_WebServiceSoap_PortType getBT4U_WebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bustracker.BT4U_WebServiceSoap_BindingStub _stub = new bustracker.BT4U_WebServiceSoap_BindingStub(portAddress, this);
    ...
    public bustracker.BT4U_WebServiceSoap_PortType getBT4U_WebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bustracker.BT4U_WebServiceSoap12Stub _stub = new bustracker.BT4U_WebServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (bustracker.BT4U_WebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                bustracker.BT4U_WebServiceSoap_BindingStub _stub = new bustracker.BT4U_WebServiceSoap_BindingStub(new java.net.URL(BT4U_WebServiceSoap_address), this);
                _stub.setPortName(getBT4U_WebServiceSoapWSDDServiceName());
                return _stub;
            }
            if (bustracker.BT4U_WebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                bustracker.BT4U_WebServiceSoap12Stub _stub = new bustracker.BT4U_WebServiceSoap12Stub(new java.net.URL(BT4U_WebServiceSoap12_address), this);
                _stub.setPortName(getBT4U_WebServiceSoap12WSDDServiceName());
                return _stub;
            }
        }

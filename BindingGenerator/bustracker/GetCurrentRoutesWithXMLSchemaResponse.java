...
public class GetCurrentRoutesWithXMLSchemaResponse  implements java.io.Serializable {
    private bustracker.GetCurrentRoutesWithXMLSchemaResponseGetCurrentRoutesWithXMLSchemaResult getCurrentRoutesWithXMLSchemaResult;

    public GetCurrentRoutesWithXMLSchemaResponse() {
    }

    public GetCurrentRoutesWithXMLSchemaResponse(
           bustracker.GetCurrentRoutesWithXMLSchemaResponseGetCurrentRoutesWithXMLSchemaResult getCurrentRoutesWithXMLSchemaResult) {
     ...
     */
    public bustracker.GetCurrentRoutesWithXMLSchemaResponseGetCurrentRoutesWithXMLSchemaResult getGetCurrentRoutesWithXMLSchemaResult() {
        return getCurrentRoutesWithXMLSchemaResult;
    }
     ...
     */
    public void setGetCurrentRoutesWithXMLSchemaResult(bustracker.GetCurrentRoutesWithXMLSchemaResponseGetCurrentRoutesWithXMLSchemaResult getCurrentRoutesWithXMLSchemaResult) {
        this.getCurrentRoutesWithXMLSchemaResult = getCurrentRoutesWithXMLSchemaResult;
    }

...
public class GetScheduledStopNamesResponse  implements java.io.Serializable {
    private bustracker.GetScheduledStopNamesResponseGetScheduledStopNamesResult getScheduledStopNamesResult;

    public GetScheduledStopNamesResponse() {
    }

    public GetScheduledStopNamesResponse(
           bustracker.GetScheduledStopNamesResponseGetScheduledStopNamesResult getScheduledStopNamesResult) {
     ...
     */
    public bustracker.GetScheduledStopNamesResponseGetScheduledStopNamesResult getGetScheduledStopNamesResult() {
        return getScheduledStopNamesResult;
    }
     ...
     */
    public void setGetScheduledStopNamesResult(bustracker.GetScheduledStopNamesResponseGetScheduledStopNamesResult getScheduledStopNamesResult) {
        this.getScheduledStopNamesResult = getScheduledStopNamesResult;
    }

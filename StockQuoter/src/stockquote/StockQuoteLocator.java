...
public class StockQuoteLocator extends org.apache.axis.client.Service implements stockquote.StockQuote {
    ...
    public stockquote.StockQuoteSoap_PortType getStockQuoteSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            stockquote.StockQuoteSoap_BindingStub _stub = new stockquote.StockQuoteSoap_BindingStub(portAddress, this);
    ...
    public stockquote.StockQuoteSoap_PortType getStockQuoteSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            stockquote.StockQuoteSoap12Stub _stub = new stockquote.StockQuoteSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (stockquote.StockQuoteSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                stockquote.StockQuoteSoap_BindingStub _stub = new stockquote.StockQuoteSoap_BindingStub(new java.net.URL(StockQuoteSoap_address), this);
                _stub.setPortName(getStockQuoteSoapWSDDServiceName());
                return _stub;
            }
            if (stockquote.StockQuoteSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                stockquote.StockQuoteSoap12Stub _stub = new stockquote.StockQuoteSoap12Stub(new java.net.URL(StockQuoteSoap12_address), this);
                _stub.setPortName(getStockQuoteSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        else if ("StockQuoteSoap12".equals(inputPortName)) {
